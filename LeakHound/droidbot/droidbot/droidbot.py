...
class DroidBot(object):
    ...
    def __init__(self,
        ...
        if output_dir is not None:
            ...
            with resources.path("droidbot.resources", "index.html") as html_index_path:
                shutil.copy(html_index_path, output_dir)

            with resources.path("droidbot.resources", "stylesheets") as stylesheets_path:
        ...
        try:
            self.device = Device(
                ...
                ignore_ad=ignore_ad,
                frida_scripts=frida_script,
                frida_output_folder=frida_output_folder,
    ...
    def start(self):
        ...
        try:
            ...
            if not self.enabled:
                return
            self.logger.info("MODIFICATION ############################ NOT INSTALLING APP, LETTING PARENT MODULE DO THAT ############################")
